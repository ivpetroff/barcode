	...
	************************************************/
	...
	$sql = "SELECT * FROM barcode_info where  1 LIMIT ".$pageLimit." , ".$setLimit;
	$query = mysql_query($sql);
         
	while ($rec = mysql_fetch_array($query)) {
	?>
	<div class="show"><a href="http://www.discussdesk.com/<?php echo $rec["barcode_ro"];?>.htm" target="_blank"><?php echo $rec['price_barcode'];?></a></div>
	<?php }	?>
	</div>
